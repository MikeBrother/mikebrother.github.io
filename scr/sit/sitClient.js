...
(function () {
    ...
    var OVERLAY_URL_SITTABLE_HMD = Script.resolvePath("./triggerToSit.png");
    var OVERLAY_URL_SITTABLE_DESKTOP = Script.resolvePath("./clickToSit.png");
    ...
    var OVERLAY_PRESIT_URL_ROOT = "./sitConfirm";
    var OVERLAY_PRESIT_URL_POSTFIX = ".png";
    var OVERLAY_PRESIT_URL_NUM = 12;
    var OVERLAY_PRESIT_URL_TEXT = Script.resolvePath("./pleaseFaceForward.png");
    ...
    var OVERLAY_URL_STANDUP = Script.resolvePath("./holdToStandUp.png");
    ...
    // Constants
    var ANIMATION_URL = Script.resolvePath("./sittingIdle.fbx");
